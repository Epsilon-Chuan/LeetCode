...
<ul>
	<li>This is a follow up problem to&nbsp;<a href="/problems/033. Search in Rotated Sorted Array.md">Search in Rotated Sorted Array</a>, where <code>nums</code> may contain duplicates.</li>
